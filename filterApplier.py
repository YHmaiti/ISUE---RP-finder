...
df = pd.read_csv(file_loc, usecols= ["title", "year_published", "link"])
    ...
    for title in titles:
        for keyword in keywords:
            ...
            if keyword.lower() in title.lower() and title not in new_titles:
                ...
                new_links.append(links[currLink])
